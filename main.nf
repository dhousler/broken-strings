...
workflow break_sites {
  ...
  //NORMALISED(sample_ch, INTERSECT.out)
  //NORMALISED(sample_ch.join(INTERSECT.out.collect()))
  NORMALISED(sample_ch, INTERSECT.out.collect())  // there must be a simpler way to do this wihtout adding all files
