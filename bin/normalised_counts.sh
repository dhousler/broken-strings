...
# NOTES:
# file1 will be original raw files, file2 will be filtered intersected
# As workflow manager handles order, no need to define specifically here, could make smarter
# decided on bash over python as very fast to count and calculate
...
#NOTE: Header is defined in the workflow params so that headers can be readily defined
